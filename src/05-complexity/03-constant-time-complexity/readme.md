...
console.time("Access arr1 element 1");
console.log(accessElement(arr1, 1));
console.timeEnd("Access arr1 element 1");

console.time("Access arr2 element 1000");
console.log(accessElement(arr2, 1000));
console.timeEnd("Access arr2 element 1000");
```

With the `console.time` and `console.timeEnd` functions, we can see how long it takes to run the code between them.

`Access Element 1` passes in an array with 5 elements and `Access arr2 element 1000` passes in an array with 10,000 elements.
...
Change the length of the `arr2` to `100,000` and run the code again.
